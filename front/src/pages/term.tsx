		...
		<>
			...
			<Terms>
				<section>
					<h1>Kiwee 약관</h1>
						<h2>Kiwee 소개</h2>
							<p>Kiwee는 여러 기술 블로그들의 포스트들을 한곳에서 모아 보여주는 서비스를 제공하는 사이트입니다.</p>
							<p>제공되는 모든 포스트들은 RSS를 제공하는 블로그에서 수집하고 있으며, 해당하는 포스트들의 저작권은 Kiwee가 아닌 해당 블로그를 소유한 곳에 있습니다.</p>
						<h2>로그인을 하면 추가적인 서비스를 이용할 수 있습니다.</h2>
						...
						<h2>여러분의 소중한 의견에 귀 기울이겠습니다.</h2>
							<p>언제든지 이메일 또는 마련된 소통 창구를 통해 서비스에 관련된 의견이나 개선사항을 전달하실 수 있으며, 처리 과정 및 결과를 전달할 수 있도록 노력하겠습니다.</p>
				</section>
			</Terms>
		</>
	)
