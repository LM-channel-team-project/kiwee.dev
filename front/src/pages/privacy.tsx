			...
			<Privacys>
				<section>
					...
					<h2>1. 개인정보처리방침이란?</h2>
						...
						<p>개인정보 처리방침이란 이용자의 소중한 개인정보를 보호함으로써 이용자가 안심하고 서비스를 이용할 수 있도록 Kiwee가 준수해야 할 지침을 의미합니다.</p>
					...
					<h2>2. 개인정보 수집</h2>
						...
						<p>PC웹, 모바일 웹/앱 이용 과정에서 단말기정보(OS, 화면사이즈, 디바이스 아이디), IP주소, 방문일시, 서비스 이용 기록 등의 정보가 자동으로 생성되어 수집될 수 있습니다.</p>
					<h2>3. 개인정보 이용</h2>
